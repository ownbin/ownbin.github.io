    ...
    $(document).ready(function ()
    {
        ...
        $.ajax(api_comments_url, {
            ...
            success: function(comments, textStatus, jqXHR) {
                ...
                if (page_id == 1)
                    $("#gh-comments-list").append("<a href='" + url + "#new_comment_field' rel='nofollow' class='btn'><i class='fa fa-comments-o' aria-hidden='true'></i> Post a comment on Github <i class='fa fa-hand-o-right' aria-hidden='true'></i></a>");
